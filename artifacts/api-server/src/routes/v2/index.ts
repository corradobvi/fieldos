...
import convocazioniRouter  from "./convocazioni";
import allenamentiNotificaRouter from "./allenamenti-notifica";
import eventiNotificaFaseRouter  from "./eventi-notifica-fase";
...
router.use(convocazioniRouter);
router.use(allenamentiNotificaRouter);
router.use(eventiNotificaFaseRouter);
